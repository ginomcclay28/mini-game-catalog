/* ============================================================
   ...
   รูปแบบการเล่น (gameplay) เป็นแบบมาตรฐาน ไม่เปลี่ยนตามการปรับแต่ง
   ============================================================ */
window.BRAND = {
  name: "T-STONE",
  ...
  /* ภาพการ์ดของแต่ละเกมในหน้าเมนู
     ใส่ path โฟลเดอร์ที่เก็บภาพ ไฟล์ต้องชื่อ 001.png ... 100.png ตามลำดับเกม
     ตั้งเป็น null = กลับไปใช้แบบเดิม (สีไล่เฉด + อิโมจิ) ภาพยังอยู่ครบไม่ต้องลบ */
  cardArt: "assets/cards/",
